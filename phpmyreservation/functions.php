...
function all_reservations(){
	...
	$users = '<table id="users_table"><tr><th>Group ID</th><th>Group Name</th><th>Reservation Date</th><th>Room</th><th>Floor</th><th>Check In Time</th><th>Check Out Time</th><th>Student Name</th><th>Student Roll No.</th><th>Student Branch</th><th>Student Email</th><th>Student Mobile Number</th></tr>';
	...
	while($user = mysqli_fetch_array($query))
	{
		...
		<td colspan="'.$group_size[$user['group_id']].'"><label for="user_radio_' . $user['group_id'] . '">' . $user['group_id'] . '</label></td><td colspan="'.$group_size[$user['group_id']].'"><label for="user_radio_' . $user['group_id'] . '">' . $user['group_name'] . '</label></td>
		<td colspan="'.$group_size[$user['group_id']].'">' . $time . '</td>
		<td colspan="'.$group_size[$user['group_id']].'">'.$user['room_name'].'</td>
		<td colspan="'.$group_size[$user['group_id']].'">'.$user['Floor'].'</td>
		<td colspan="'.$group_size[$user['group_id']].'">'.$user['reservation_check_in'].'</td>
		<td colspan="'.$group_size[$user['group_id']].'">'.$user['reservation_check_out'].'</td>
		';
