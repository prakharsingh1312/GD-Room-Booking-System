...
echo'<div class="box_div" id="reservation_div"><div class="box_top_div" id="reservation_top_div"><div id="reservation_top_left_div"><a href="." id="previous_day_a">&lt; Previous day</a></div><div id="reservation_top_center_div">Reservations for day<span class="week_number_span" id="'.global_week_number.':'.global_day_number.'">'.$date.'</span></div><div id="reservation_top_right_div"><a href="." id="next_day_a">Next day &gt;</a></div></div><div class="box_body_div" id="availability_div">
